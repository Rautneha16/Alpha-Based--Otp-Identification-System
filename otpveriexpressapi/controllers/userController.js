...
const accountSid = process.env.TWILIO_ACCOUNT_SID || 'AC9de6acea217042c80611734ba56c2e9f';
const authToken = process.env.TWILIO_AUTH_TOKEN || 'a47c96bf31d4e2c256fe046a609446e3'; 
...
class UserController {
  ...
  static userLogin = async (req, res) => {
    ...
    .create({
        from: process.env.TWILIO_PHONE_NUMBER || '+14058296306',
        to: `${newPhoneNumber}`,
